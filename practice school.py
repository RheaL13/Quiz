...
"""
    ...
    def open_photos_window(self):
        ...
        video_url_label=Label(self.photos_window, text="Video About Our "+
        ...
        btn=Button(self.photos_window, text="Play Video 1",
        ...
        # Label for video URL input
        video_url_label=Label(self.photos_window, text="Video About How "+
        ...
        # Button to open the video
        btn=Button(self.photos_window, text="Play Video 2",
        ...
        # Button to open the video
        btn=Button(self.photos_window, text="Play Video 3",
        ...
        # Label for video URL input
        video_url_label=Label(self.photos_window, text=" Video About Global"+
        ...
        # Button to open the video
        btn=Button(self.photos_window, text="Play Video 4",
                     font=("Helvetica", 12, 'bold'), command=open_video4)
        btn.pack(pady=7)

        back=Button(self.photos_window, text="EXIT", 
